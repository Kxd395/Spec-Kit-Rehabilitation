...
class TestGetStats:
    ...
    def test_get_stats_with_findings(self, tmp_path):
        ...
        finding1 = {"file": "test.py", "line": 10, "rule_id": "B101", "severity": "HIGH", "message": "Test 1"}
        finding2 = {"file": "app.py", "line": 20, "rule_id": "B101", "severity": "HIGH", "message": "Test 2"}
        finding3 = {"file": "main.py", "line": 30, "rule_id": "B201", "severity": "MEDIUM", "message": "Test 3"}
